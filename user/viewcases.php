...
$res1=mysqli_query($con,$sql);?>
				<table>
				<tr><td>Crime date</td><td>Case details</td><td>Status</td><td>Lawyer</td></tr>
<?php
...
<td><textarea disabled="disabled"><?php echo $j['status'];?></textarea></td><td><a href="viewlprofile.php?did=<?php echo $r['detailid'];?>">Lawyer Profile</a></tr>
<?php
}
?></table>
					</div>
